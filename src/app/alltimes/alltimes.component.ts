...
export class AlltimesComponent implements OnInit {
  ...
  ngOnInit() {
        this.addTimesheetForm = this.fb.group({
    ...
    const AllClientsQuery = gql`
      ...
      saveTimeSheetEntry() {
            const user = this.addTimesheetForm.value.User;
            const project = this.addTimesheetForm.value.Project;
            const category = this.addTimesheetForm.value.Category;
            const startTime = this.addTimesheetForm.value.StartTime;
            const endTime = this.addTimesheetForm.value.EndTime;
